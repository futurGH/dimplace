...
export type CoursePageQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', name: string, imageUrl?: string | null, homeUrl?: string | null } | null, activityFeedArticlePage?: { __typename?: 'ActivityFeedArticlePage', id: string, activityFeedArticles: Array<(
    ...
    ) | { __typename?: 'ActivityFeedAssignment' }> } | null };

export type ArticleDetailsFragment = { __typename?: 'ActivityFeedArticle', id: string, type: string, message: string, publishedDate: string, allCommentsLink?: string | null, commentsCount: number, isPinned: boolean, author: (
    { __typename?: 'User' }
    & { ' $fragmentRefs'?: { 'UserDetailsFragment': UserDetailsFragment } }
  ), attachmentLinks: Array<(
    { __typename?: 'ActivityFeedLink' }
    & { ' $fragmentRefs'?: { 'LinkDetailsFragment': LinkDetailsFragment } }
  )>, firstComment?: (
    { __typename?: 'ActivityFeedComment' }
    & { ' $fragmentRefs'?: { 'CommentDetailsFragment': CommentDetailsFragment } }
  ) | null } & { ' $fragmentName'?: 'ArticleDetailsFragment' };

export type AssignmentDetailsFragment = { __typename?: 'ActivityFeedAssignment', id: string, type: string, publishedDate: string, allCommentsLink?: string | null, commentsCount: number, name: string, instructions?: string | null, dueDate?: string | null, submissionLink?: string | null, isPinned: boolean, author: (
    { __typename?: 'User' }
    & { ' $fragmentRefs'?: { 'UserDetailsFragment': UserDetailsFragment } }
  ), attachmentLinks: Array<(
    { __typename?: 'ActivityFeedLink' }
    ...
    { __typename?: 'ActivityFeedComment' }
    & { ' $fragmentRefs'?: { 'CommentDetailsFragment': CommentDetailsFragment } }
  ) | null } & { ' $fragmentName'?: 'AssignmentDetailsFragment' };

export type UserDetailsFragment = { __typename?: 'User', id: string, displayName?: string | null, firstName?: string | null, lastName?: string | null, imageUrl?: string | null } & { ' $fragmentName'?: 'UserDetailsFragment' };

export type LinkDetailsFragment = { __typename?: 'ActivityFeedLink', id: string, type: string, name: string, href: string } & { ' $fragmentName'?: 'LinkDetailsFragment' };

export type CommentDetailsFragment = { __typename?: 'ActivityFeedComment', id: string, message: string, publishedDate: string, author: (
    { __typename?: 'User' }
    & { ' $fragmentRefs'?: { 'UserDetailsFragment': UserDetailsFragment } }
...
export const LinkDetailsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LinkDetails"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ActivityFeedLink"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"href"}}]}}]} as unknown as DocumentNode<LinkDetailsFragment, unknown>;
export const CommentDetailsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CommentDetails"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ActivityFeedComment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserDetails"}}]}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"publishedDate"}}]}},...UserDetailsFragmentDoc.definitions]} as unknown as DocumentNode<CommentDetailsFragment, unknown>;
export const ArticleDetailsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ArticleDetails"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ActivityFeedArticle"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserDetails"}}]}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"publishedDate"}},{"kind":"Field","name":{"kind":"Name","value":"attachmentLinks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LinkDetails"}}]}},{"kind":"Field","name":{"kind":"Name","value":"allCommentsLink"}},{"kind":"Field","name":{"kind":"Name","value":"commentsCount"}},{"kind":"Field","name":{"kind":"Name","value":"firstComment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CommentDetails"}}]}},{"kind":"Field","name":{"kind":"Name","value":"isPinned"}}]}},...UserDetailsFragmentDoc.definitions,...LinkDetailsFragmentDoc.definitions,...CommentDetailsFragmentDoc.definitions]} as unknown as DocumentNode<ArticleDetailsFragment, unknown>;
